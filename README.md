...
```
cd existing_repo
git remote add origin https://gitlab.com/alperade/raisin-data-collection-and-analysis.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/alperade/raisin-data-collection-and-analysis/-/settings/integrations)
